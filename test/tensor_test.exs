defmodule TensorTest do
  ...
  test "tensor merge" do
    ...
    assert Tensor.merge(prefixes, postfixes, fn a, b -> a <> b end) ==
             Tensor.new(["foobaz", "barqux"], [2], "")
  end
  ...
  test "merging tensors only works when same dimensions" do
    ...
    assert_raise(Tensor.DimensionsDoNotMatchError, fn ->
      Tensor.merge(prefixes, postfixes, fn a, b -> a <> b end)
    end)
  end
